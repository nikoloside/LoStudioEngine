...
namespace detail
{
	...
	{
		GLM_FUNC_QUALIFIER vec<2, T, Q> operator ()()  const { return vec<2, T, Q>(elem(E0), elem(E1)); }
	};
	...
	{
		GLM_FUNC_QUALIFIER vec<3, T, Q> operator ()()  const { return vec<3, T, Q>(elem(E0), elem(E1), elem(E2)); }
	};
	...
	{ 
		GLM_FUNC_QUALIFIER vec<4, T, Q> operator ()()  const { return vec<4, T, Q>(elem(E0), elem(E1), elem(E2), elem(E3)); }
	};

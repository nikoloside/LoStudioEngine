...
#	endif//!GLM_HAS_DEFAULTED_FUNCTIONS
	...
	GLM_FUNC_QUALIFIER mat<4, 2, T, Q>::mat(T scalar)
	{
		...
		value[2] = col_type(0, 0);
		value[3] = col_type(0, 0);
	}
	...
	{
		value[0] = col_type(x0, y0);
		value[1] = col_type(x1, y1);
		value[2] = col_type(x2, y2);
		value[3] = col_type(x3, y3);
	}
	...
	{
		value[0] = col_type(static_cast<T>(x1), value_type(y1));
		value[1] = col_type(static_cast<T>(x2), value_type(y2));
		value[2] = col_type(static_cast<T>(x3), value_type(y3));
		value[3] = col_type(static_cast<T>(x4), value_type(y4));
	}

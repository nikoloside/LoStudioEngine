...
#	endif//!GLM_HAS_DEFAULTED_FUNCTIONS
	...
	{
		value[0] = col_type(s, 0, 0);
		value[1] = col_type(0, s, 0);
		value[2] = col_type(0, 0, s);
	...
	{
		value[0] = col_type(static_cast<T>(x1), value_type(y1), value_type(z1));
		value[1] = col_type(static_cast<T>(x2), value_type(y2), value_type(z2));
		value[2] = col_type(static_cast<T>(x3), value_type(y3), value_type(z3));
		value[3] = col_type(static_cast<T>(x4), value_type(y4), value_type(z4));
	}

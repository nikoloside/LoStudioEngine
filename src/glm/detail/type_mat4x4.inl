...
#	endif//!GLM_HAS_DEFAULTED_FUNCTIONS
	...
	{
		value[0] = col_type(s, 0, 0, 0);
		value[1] = col_type(0, s, 0, 0);
		value[2] = col_type(0, 0, s, 0);
		value[3] = col_type(0, 0, 0, s);
	}
	...
	{
		value[0] = col_type(x0, y0, z0, w0);
		value[1] = col_type(x1, y1, z1, w1);
		value[2] = col_type(x2, y2, z2, w2);
		value[3] = col_type(x3, y3, z3, w3);
	}
	...
	)
	{
		...
		value[0] = col_type(static_cast<T>(x1), value_type(y1), value_type(z1), value_type(w1));
		value[1] = col_type(static_cast<T>(x2), value_type(y2), value_type(z2), value_type(w2));
		value[2] = col_type(static_cast<T>(x3), value_type(y3), value_type(z3), value_type(w3));
		value[3] = col_type(static_cast<T>(x4), value_type(y4), value_type(z4), value_type(w4));
	}
...
#	if !GLM_HAS_DEFAULTED_FUNCTIONS
		...
		GLM_FUNC_QUALIFIER mat<4, 4, T, Q>& mat<4, 4, T, Q>::operator=(mat<4, 4, T, Q> const& m)
		{
			...
			//memcpy(&value, &m.value, 16 * sizeof(valType));
			value[0] = m[0];
			value[1] = m[1];
			value[2] = m[2];
			value[3] = m[3];
